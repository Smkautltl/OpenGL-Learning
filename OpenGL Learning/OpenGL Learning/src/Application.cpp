...
int main(void)
{
	...
	GLCall(glBufferData(GL_ARRAY_BUFFER, 6 * 2 * sizeof(float), Positions, GL_STATIC_DRAW)); //This added the Positions data to the buffer as STATIC meaning that the data won't change but can be called multiple times
